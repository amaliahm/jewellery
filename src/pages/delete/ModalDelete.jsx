...
export default function ModalDelete({ delete_, setDelete_, detail, all_data, setAllData, ...props}) {
    const handleClose = () => setDelete_(false);
    ...
    return (
      <div>
        ...
        {supprimer && <Notification name={`${data} a été supprimée'`}/>}
      </div>
    );
  }