...
const generateHtmlTable = (data, name, date, nom, id, wilaya, ville, adresse, telephone, total, quantite, achat_numero) => {
  ...
  const exportAllDataToPdf = (data, name) => {
    ...
    const htmlContent = generateHtmlTable(all_data, name, date, nom, id, wilaya, ville, adresse, telephone, total, quantite, achat_numero);
