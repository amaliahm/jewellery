  ...
  const signature = `<h6 style="${signature_style}"> EURL BN ZAHAV </h6>`
    ...
    <div style="${info_div_style}">
      <div style="${info_half_div_style}">
        ...
        <div style="${info_head_half_div_style}">
          ...
          <p style="${reste_entreprise_nom_style}">${data['achat importation n=°']}</p>
    ...
    <div style="${tableau_div_style}">
      <table style="${tableStyles}" border="1">
        <thead>
          <th style="${thStyles}">poid 18k</th>
          <th style="${thStyles}">poid 24K</th>
          <th style="${thStyles}">prix unitaire</th>
          <th style="${thStyles}">total</th>
        </thead>
        <tbody> 
           <tr>
              <td style="${tdStyles}">${data['poid 18k']}</td>
              <td style="${tdStyles}">${data['poid 24k']}</td>
              <td style="${tdStyles}">${data['prix unitaire']}</td>
              <td style="${tdStyles}">${data.total}</td>
           </tr>
        </tbody>
      </table>
    </div>
