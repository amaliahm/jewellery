...
const generateHtmlTable = (data, name, date, nom, id, wilaya, ville, adresse, telephone) => {
    ...
    <div style="${info_div_style}">
      <div style="${info_half_div_style}">
        ...
        <div style="${info_head_half_div_style}">
          ...
          <p style="${reste_entreprise_nom_style}">${data['command n=°']}</p>
          <p style="${reste_entreprise_nom_style}">${date} </p>
        </div>
      </div>
  ...
  const exportAllDataToPdf = (data, name) => {
    const htmlContent_client = generateHtmlTable(data, name, data.date, data.nom_client, data.id_client, data.wilaya_client, data.ville_client, data.adresse_client, data.telephone_client);
    const htmlContent_fournisseur = generateHtmlTable(data, name, data.date, data.nom_fournisseur, data.id_fournisseur, data.wilaya_fournisseur, data.ville_fournisseur, data.adresse_fournisseur, data.telephone_fournisseur);
