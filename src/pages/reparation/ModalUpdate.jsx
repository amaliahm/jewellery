...
export default function ModalUpdate({showModal, setShowModal, ...props}) {
    ...
    const update = async (data) => {
      try {
          const result = await axios.put(api + `magasins/${props.detail.id_magasin}/${props.detail.id_reparation}`, data)
          ...
          <Box sx={{
            ...
            <Box sx={button_box}>
              ...
              <Button 
                ...
                disabled={inter.observation === '' || inter.fournisseur_titre === 0 || inter.prix_fournisseur === 0 || inter.poids === 0 || inter.prix_client === 0 || inter.client_titre === 0 || inter.fournisseur_titre === 0 || inter.fournisseur_titre === 0 || inter.fournisseur_titre === 0}
              >confirmer</Button>
            </Box>
          </Box>
        </Modal>
