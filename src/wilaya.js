...
function display(name) {
    const result = wilaya.filter(item =>
         (item.wilaya_name_ascii + ' ' +  item.wilaya_code) === name)
    return result.map(item => item.commune_name_ascii)
}

export {wilaya, wilayas, display}